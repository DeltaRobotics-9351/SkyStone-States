...
@Autonomous(name="A-Autonomo Skystone Azul", group="Final")
public class AutonomoSkystoneAzul_1 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if(pattern == 1) {
            ...
            timeDrive.forward(0.6,1.1);
            sleep((long)1000);
            imuTurn.rotate(90, 0.4);
            timeDrive.backwards(0.6,2.3);
