...
public class AutonomoFoundationSkystoneAzul extends IMUPIDEncoderMecanumLinearOpMode { //extendemos una clase que ya contiene todos los metodos de encoders y IMU para optimizar el codigo y el tiempo
    //Daniel es un otaku
    public Hardware hdw;
    ...
    public void _runOpMode(){
        ...
        skystonePipeline.alliance = SkystonePatternPipeline.Alliance.BLUE;

        setPID(new PIDCoefficients(0.0152, 0, 0));
        imuParameters.DEAD_ZONE = 0.09;
        imuParameters.INVERT_ROTATION = true;
        ...
        switch (pattern) {
            ...
            case A: //Pattern A
                ...
                strafeLeft(8, 0.12, 10); //nos deslizamos hacia la skystone

                forward(4, 1, 2); //nos alineamos con la pared para corregir si el robot se enchueco

                backwards(23.2, 1, 10); //avanzamos hacia la skystone
                ...
                backwards(14, 0.3, 10); //nos acercamos a la foundation
            ...
            case B: //Pattern B
                ...
                strafeRight(8, 0.12, 10); //nos deslizamos hacia la skystone
                ...
                backwards(14, 0.3, 10); //avanzamos hacia la foundation
            ...
            case C: //Pattern C
                ...
                strafeRight(16, 0.12, 10); //nos deslizamos hacia la skystone 2

                forward(4, 1, 2); //nos alineamos con la pared

                backwards(23.2, 1, 10); //avanzamos hacia ella
